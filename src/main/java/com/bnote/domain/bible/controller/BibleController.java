...
public class BibleController {
	...
	public RsData<BibleChapterResponse> getChapter(
		...
		return RsData.ok("성경 조회 성공", bibleService.getChapter(bookId, chapter, translation));
	}
	...
	public RsData<BibleSearchResponse> search(
		...
		return RsData.ok("성경 검색 성공", bibleService.search(keyword, translation));
	}

	@GetMapping("/translations")
	public RsData<TranslationResponse> getTranslations() {
		return RsData.ok("대역본 목록 조회 성공", TranslationResponse.ofAll());
	}
}